...
import 'package:loksewa/view_model.dart/mock_test_view_model.dart';
import 'package:provider/provider.dart';

import '../../view_model.dart/selectcareer_view_model.dart';

// ignore: must_be_immutable
class MockTestQuestion extends StatelessWidget {
  ...
  MockTestQuestion({super.key});

  @override
  Widget build(BuildContext context) {
    final selectboxViewModel = Provider.of<SelectboxViewModel>(context);
    final viewModel = Provider.of<MockTestViewModel>(context, listen: true);
    viewModel.timer();
            ...
            children: [
              ...
              Stack(
                ...
                children: [
                  ...
                  Text(
                    viewModel.counter.toString(), // Displaying percentage
                    style: TextStyle(
                      fontSize: 20,
